        ...
        <>
            ...
            <div className="bg-black w-full   relative  ">
                <div className='mx-96 xxl:mx-0 '>
                    ...
                    <div className=' xxs:px-0 px-5 mx-auto py-[38px] '>
                        <div className='border rounded-[25px] flex justify-center items-center flex-col z-10 p-4  text-white px-4   relative  xxs:mx-4'>
